define(['plugins/dialog', 'knockout', 'i18n', 'jquery'],
  function (Dialog, ko, i18n, $) {
    ...
    var CustomDialog = function (opts) {
      ...
      this.showFourthBtn = opts.showFourthBtn || false;
      this.fourthBtnText = opts.fourthBtnText || 'Fourth Button';
      this.fourthBtnClasses = opts.fourthBtnClasses || 'btn btn-default';
      this.fourthBtnReturnStatus = opts.fourthBtnReturnStatus || 'fourthButtonClicked';
    ...
    CustomDialog.prototype = {
      ...
      fourth: function () {
        var status = this.fourthBtnReturnStatus;
        this._executeAction(status);
      },
